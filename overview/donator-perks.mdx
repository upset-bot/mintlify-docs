---
title: "Donator Perks"
description: "Donator perks are rewards given to those who choose to donate to upset."
icon: "dollar-sign"
---

## How to obtain Donator Perks

Donator perks can be purchased via **server subscriptions** in our [Support Server](https://discord.gg/upsetbot) which can be found at the top of the channel list labeled as **Server Shop**.
...
<AccordionGroup>
    ...
    <Accordion title="Video to GIF conversion">
      ...
      <CodeGroup>
        ...
        ```
        ```javascript Example
        ,makegif https://upset.bot/backflip.mp4 100 30 2
        ```
      </CodeGroup>
    </Accordion>
    <Accordion title="Clever Chatbot">
      ...
      <Info>
        `upset clever` is the unique prefix for this command.
      </Info>
      <CodeGroup>
        ```javascript Syntax
        upset clever (question)
        ```
        ```javascript Example
        upset clever I know what you are...
        ```
      </CodeGroup>
    </Accordion>
    <Accordion title="Background Removal">
      ...
      <CodeGroup>
        ...
        ```
        ```javascript Example
        ,transparent https://upset.bot/epic_face.png
        ```
      </CodeGroup>
    </Accordion>
    ...
    <Accordion title="Custom Prefix">
      Set your own custom command prefix across all servers that utilize upset.
      <CodeGroup>
        ```javascript Syntax
        ,prefix self (prefix)
        ```
