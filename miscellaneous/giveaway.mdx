...
<AccordionGroup>
    ...
    <Accordion title="Changing the prize">
        ...
        ```javascript Example
        ,giveaway edit prize .../channels/... upset whitelist
        ```
        </CodeGroup>
    </Accordion>
...
<AccordionGroup>
    ...
    <Accordion title="Changing the thumbnail">
        ...
        ```javascript Example
        ,giveaway edit thumbnail .../channels/... https://upset.bot/upset.png
        ```
    ...
    <Accordion title="Changing the image">
        ...
        ```javascript Example
        ,giveaway edit image .../channels/... https://upset.bot/upset.png
        ```
...
<AccordionGroup>
    ...
    <Accordion title="Setting a required level">
        ...
        <Warning>This relies on upset's [leveling system](/configuration/level-rewards), not other bots.</Warning>
        <CodeGroup>
        ```javascript Syntax
